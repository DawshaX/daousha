...
## النشر — 2026-08-20 (07:23 UTC / 10:23 صباحًا القاهرة — تشغيل مجدول، الحلقة 26)
| الحلقة | الموضوع | YouTube | Instagram | Facebook |
|---|---|---|---|---|
| 26 | الجبال ليست ثابتة... بل تتحرك! | — pending (secrets.txt غائب — نفس القيد منذ 2026-08-15) | https://www.instagram.com/reel/DcQN5XjD4tD/ | — pending (نفس السبب) |
نُشر بعد احترام حد «قطعتين بفارق ≥4 ساعات» (منشور ep26 الأول كان ~03:21 UTC؛ النافذة انفتحت ~07:21 UTC — النشر عند 07:23 UTC). الحلقة 27 (السرعة — AR + EN): تبقى produced-partial؛ الصور الثمانية (4 AR + 4 EN) مؤجلة بسبب نفاد حصة الصور المجانية (20/20) مجددًا — تُنتج في التشغيل المجدول التالي ثم تُبنى الفيديوهان (AR + EN) ويُنشران على IG. YT/FB/Telegram معطلة بيئيًا.

## TikTok — فحص 2026-08-20 (07:00 UTC / 10:00 صباحًا القاهرة)
صفحة المطورين تعرض «No access — You need to login» في متصفح المستخدم مجددًا (نفس النتيجة المتكررة). آخر حالة مسجلة تبقى: **Production / In review** منذ 2026-08-14. لا إعادة تقديم ولا تغيير إعدادات.

## سجل تلجرام — 2026-08-20 (10:25 صباحًا القاهرة)
لم يُرسل إشعار تلجرام (بوت xDaw_NOVA يتطلب secrets.txt الغائب منذ 2026-08-15). تقرير الدورة يُرسل داخل المحادثة.
...
## الإنتاج — 2026-08-20 (05:05 UTC / 8:05 صباحًا القاهرة — تشغيل مجدول، لا نشر)
| الحلقة | الموضوع | الحالة |
|---|---|---|
| 27 | أسرع من الضوء؟ 3 حقائق صادمة عن السرعة ستفجّر عقلك (AR + EN) | produced-partial (لا تغيير)
لا إنتاج جديد هذه الدورة: حصة توليد الصور المجانية (20/20) نفدت في دورة 03:35 UTC نفسها (صور ep26)؛ ep27 تحتاج 8 صور فقط (4 AR + 4 EN) ثم بناء الفيديوهين ونشر AR+EN على IG في الدورة التالية. YT/FB/Telegram معطلة بيئيًا (secrets.txt غائب منذ 2026-08-15). Instagram محجوز بحد 4 ساعات حتى ~07:21 UTC بعد منشور ep26 الساعة 03:21 UTC.
...
## TikTok — فحص مباشر 2026-08-20 (08:12 UTC / 11:12 صباحًا القاهرة)
الحالة الرسمية: **Production — Not approved** — سجل TikTok Admin: «Updated Status from Under review to Rejected» بتاريخ 2026-08-19 9:15 AM. لم تعد «In review». الأسباب التفصيلية عبر «See why» (لم تُراجع). عند إعادة التقديم يجب حذف Direct Post والاكتفاء بدرافت video.upload. لا نشر على TikTok حتى البتّ.

## الإنتاج — 2026-08-20 (08:06 UTC / 11:06 صباحًا القاهرة — تشغيل مجدول)
لا إنتاج ولا نشر هذه الدورة: حصة توليد الصور (20/20) مستهلكة مجددًا (محاولتا توليد مشاهد ep27 فشلتا)، ونافذة IG تفتح 11:23 UTC (كولداون 4 ساعات بعد منشور ep26 الساعة 07:23 UTC)، وYT/FB/Telegram معطلة (secrets.txt غائب منذ 2026-08-15). ep27 تبقى produced-partial: السيناريو AR+EN + narration27-ar (45.8s) + narration27-en (45.4s) — تبقى 8 صور ثم بناء الفيديوهين ونشر AR+EN على IG في الدورة القادمة.
