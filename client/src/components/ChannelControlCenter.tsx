      ...
      <section className="grid gap-4 xl:grid-cols-2">
        ...
        <Card className="border-white/8 bg-zinc-950/60">
          ...
          <CardContent className="space-y-4">
            ...
            {facebook?.status === "authorized" ? <div className="rounded-xl border border-emerald-400/20 bg-emerald-400/[0.05] p-3 text-xs leading-6 text-emerald-100/85"><b>حالة التفويض:</b> رُبطت صفحة Facebook رسميًا. يظل أي رفع محكومًا بالحواجز، وتتحقق المراقبة من هوية الصفحة والرمز كل 6 ساعات من دون نشر محتوى.</div> : <div className="rounded-xl border border-amber-400/20 bg-amber-400/[0.05] p-3 text-xs leading-6 text-amber-100/85"><b>تنبيه التفويض:</b> تهيئة تطبيق Meta لا تثبت صلاحية رمز الصفحة. عند خطأ الرمز أو إلغائه يظل رفع Facebook محجوبًا إلى أن يُجدد عبر المسار الرسمي ثم ينجح فحص قراءة جديد.</div>}
