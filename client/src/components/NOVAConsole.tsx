    ...
    <div className="space-y-5">
      ...
      <Card className="border-white/8 bg-zinc-950/65">
        ...
        <CardContent className="space-y-3 p-3">
          ...
          <p className="rounded-lg border border-white/6 bg-black/20 px-2.5 py-2 text-[10px] leading-5 text-zinc-500">{advisorProviders.data?.find(provider => provider.id === advisorProvider)?.detail ?? "يجري تحميل حالة المزود. لا تُرسل أي معلومة حساسة."}</p>
