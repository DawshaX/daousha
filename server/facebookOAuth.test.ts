...
describe("Facebook OAuth", () => {
  it("uses a same-origin callback and only the scopes needed to select a Page and publish one video", () => {
    ...
    expect(facebookScopes()).toEqual(["pages_show_list", "pages_read_engagement", "pages_manage_posts", "publish_video"]);
